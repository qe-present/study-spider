...
html.get("http://localhost:54536/study-spider/src/spiderDemo/T8/one/main.html")
...
for page in range(1,101):
    ...
    for child in children:
        string_result=ocr.classification(child.get_screenshot(as_bytes='png'))
        total+=int(string_result)
